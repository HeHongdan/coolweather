...
import com.hehongdan.coolweather.BuildConfig;
...
public class MyLogger {
    ...
    /** 日志的标记（一般为类名） */
    public final static String                  tag             = "[酷欧天气]";
    /** 日志的级别 */
